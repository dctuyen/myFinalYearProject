...
<head>
    ...
    <!--switchery-->
    <link href="{{ asset('theme/js/switchery/switchery.min.css') }}" rel="stylesheet" type="text/css" media="screen" />
...
<script src="{{ asset('theme/js/jquery-migrate.js') }}"></script>
...
<!--switchery-->
<script src="{{ asset('theme/js/switchery/switchery.min.js') }}"></script>
<script src="{{ asset('theme/js/switchery/switchery-init.js') }}"></script>

<!--Sparkline Chart-->
<script src="{{ asset('theme/js/sparkline/jquery.sparkline.js') }}"></script>
<script src="{{ asset('theme/js/sparkline/sparkline-init.js') }}"></script>
